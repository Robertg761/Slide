...
/**
 * Publisher-provided trace with a stable expected result, used to validate the complete native
 * inference and search contract before the neural decoder is exposed to the keyboard.
 */
internal object NeuralSwipeHealthCheck {
    const val expectedWord = "computer"

    val keys: GestureKeyMap by lazy {
        val centers = mapOf(
        ...
        requireNotNull(builder.buildOrNull())
    }
